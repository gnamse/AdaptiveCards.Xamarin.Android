...
namespace IO.Adaptivecards.Renderer.Readonly {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.adaptivecards.renderer.readonly']/class[@name='ContainerRenderer']"
	[global::Android.Runtime.Register ("io/adaptivecards/renderer/readonly/ContainerRenderer", DoNotGenerateAcw=true)]
	public partial class ContainerRenderer : global::IO.Adaptivecards.Renderer.BaseCardElementRenderer {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/adaptivecards/renderer/readonly/ContainerRenderer", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ContainerRenderer); }
		}

		protected ContainerRenderer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.adaptivecards.renderer.readonly']/class[@name='ContainerRenderer']/constructor[@name='ContainerRenderer' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		protected unsafe ContainerRenderer ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ContainerRenderer)) {
					SetHandle (
		...
		public static unsafe global::IO.Adaptivecards.Renderer.Readonly.ContainerRenderer Instance {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.adaptivecards.renderer.readonly']/class[@name='ContainerRenderer']/method[@name='getInstance' and count(parameter)=0]"
			[Register ("getInstance", "()Lio/adaptivecards/renderer/readonly/ContainerRenderer;", "GetGetInstanceHandler")]
			get {
				if (id_getInstance == IntPtr.Zero)
					id_getInstance = JNIEnv.GetStaticMethodID (class_ref, "getInstance", "()Lio/adaptivecards/renderer/readonly/ContainerRenderer;");
				try {
					return global::Java.Lang.Object.GetObject<global::IO.Adaptivecards.Renderer.Readonly.ContainerRenderer> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getInstance), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::IO.Adaptivecards.Renderer.Readonly.ContainerRenderer __this = global::Java.Lang.Object.GetObject<global::IO.Adaptivecards.Renderer.Readonly.ContainerRenderer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.adaptivecards.renderer.readonly']/class[@name='ContainerRenderer']/method[@name='render' and count(parameter)=8 and parameter[1][@type='io.adaptivecards.renderer.RenderedAdaptiveCard'] and parameter[2][@type='android.content.Context'] and parameter[3][@type='android.support.v4.app.FragmentManager'] and parameter[4][@type='android.view.ViewGroup'] and parameter[5][@type='io.adaptivecards.objectmodel.BaseCardElement'] and parameter[6][@type='io.adaptivecards.renderer.actionhandler.ICardActionHandler'] and parameter[7][@type='io.adaptivecards.objectmodel.HostConfig'] and parameter[8][@type='io.adaptivecards.objectmodel.ContainerStyle']]"
