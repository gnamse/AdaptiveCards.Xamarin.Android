...
namespace IO.Adaptivecards.Renderer.Input {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.adaptivecards.renderer.input']/class[@name='ToggleInputRenderer']"
	[global::Android.Runtime.Register ("io/adaptivecards/renderer/input/ToggleInputRenderer", DoNotGenerateAcw=true)]
	public partial class ToggleInputRenderer : global::IO.Adaptivecards.Renderer.BaseCardElementRenderer {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/adaptivecards/renderer/input/ToggleInputRenderer", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ToggleInputRenderer); }
		}

		protected ToggleInputRenderer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.adaptivecards.renderer.input']/class[@name='ToggleInputRenderer']/constructor[@name='ToggleInputRenderer' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		protected unsafe ToggleInputRenderer ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ToggleInputRenderer)) {
					SetHandle (
		...
		public static unsafe global::IO.Adaptivecards.Renderer.Input.ToggleInputRenderer Instance {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.adaptivecards.renderer.input']/class[@name='ToggleInputRenderer']/method[@name='getInstance' and count(parameter)=0]"
			[Register ("getInstance", "()Lio/adaptivecards/renderer/input/ToggleInputRenderer;", "GetGetInstanceHandler")]
			get {
				if (id_getInstance == IntPtr.Zero)
					id_getInstance = JNIEnv.GetStaticMethodID (class_ref, "getInstance", "()Lio/adaptivecards/renderer/input/ToggleInputRenderer;");
				try {
					return global::Java.Lang.Object.GetObject<global::IO.Adaptivecards.Renderer.Input.ToggleInputRenderer> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getInstance), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::IO.Adaptivecards.Renderer.Input.ToggleInputRenderer __this = global::Java.Lang.Object.GetObject<global::IO.Adaptivecards.Renderer.Input.ToggleInputRenderer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.adaptivecards.renderer.input']/class[@name='ToggleInputRenderer']/method[@name='render' and count(parameter)=8 and parameter[1][@type='io.adaptivecards.renderer.RenderedAdaptiveCard'] and parameter[2][@type='android.content.Context'] and parameter[3][@type='android.support.v4.app.FragmentManager'] and parameter[4][@type='android.view.ViewGroup'] and parameter[5][@type='io.adaptivecards.objectmodel.BaseCardElement'] and parameter[6][@type='io.adaptivecards.renderer.actionhandler.ICardActionHandler'] and parameter[7][@type='io.adaptivecards.objectmodel.HostConfig'] and parameter[8][@type='io.adaptivecards.objectmodel.ContainerStyle']]"
