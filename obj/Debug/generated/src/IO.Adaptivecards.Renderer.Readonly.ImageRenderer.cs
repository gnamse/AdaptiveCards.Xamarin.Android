...
namespace IO.Adaptivecards.Renderer.Readonly {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.adaptivecards.renderer.readonly']/class[@name='ImageRenderer']"
	[global::Android.Runtime.Register ("io/adaptivecards/renderer/readonly/ImageRenderer", DoNotGenerateAcw=true)]
	public partial class ImageRenderer : global::IO.Adaptivecards.Renderer.BaseCardElementRenderer {

		// Metadata.xml XPath class reference: path="/api/package[@name='io.adaptivecards.renderer.readonly']/class[@name='ImageRenderer.ImageRendererImageLoaderAsync']"
		[global::Android.Runtime.Register ("io/adaptivecards/renderer/readonly/ImageRenderer$ImageRendererImageLoaderAsync", DoNotGenerateAcw=true)]
		public partial class ImageRendererImageLoaderAsync : global::Java.Lang.Object {

			internal static new IntPtr java_class_handle;
			internal static new IntPtr class_ref {
				get {
					return JNIEnv.FindClass ("io/adaptivecards/renderer/readonly/ImageRenderer$ImageRendererImageLoaderAsync", ref java_class_handle);
				}
			}
			...
			protected override global::System.Type ThresholdType {
				get { return typeof (ImageRendererImageLoaderAsync); }
			}

			protected ImageRendererImageLoaderAsync (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/adaptivecards/renderer/readonly/ImageRenderer", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ImageRenderer); }
		}

		protected ImageRenderer (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.adaptivecards.renderer.readonly']/class[@name='ImageRenderer']/constructor[@name='ImageRenderer' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		protected unsafe ImageRenderer ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ImageRenderer)) {
					SetHandle (
		...
		public static unsafe global::IO.Adaptivecards.Renderer.Readonly.ImageRenderer Instance {
			// Metadata.xml XPath method reference: path="/api/package[@name='io.adaptivecards.renderer.readonly']/class[@name='ImageRenderer']/method[@name='getInstance' and count(parameter)=0]"
			[Register ("getInstance", "()Lio/adaptivecards/renderer/readonly/ImageRenderer;", "GetGetInstanceHandler")]
			get {
				if (id_getInstance == IntPtr.Zero)
					id_getInstance = JNIEnv.GetStaticMethodID (class_ref, "getInstance", "()Lio/adaptivecards/renderer/readonly/ImageRenderer;");
				try {
					return global::Java.Lang.Object.GetObject<global::IO.Adaptivecards.Renderer.Readonly.ImageRenderer> (JNIEnv.CallStaticObjectMethod  (class_ref, id_getInstance), JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::IO.Adaptivecards.Renderer.Readonly.ImageRenderer __this = global::Java.Lang.Object.GetObject<global::IO.Adaptivecards.Renderer.Readonly.ImageRenderer> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
