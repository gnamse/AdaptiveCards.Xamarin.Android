...
namespace IO.Adaptivecards.Objectmodel {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='io.adaptivecards.objectmodel']/class[@name='OpenUrlActionParser']"
	[global::Android.Runtime.Register ("io/adaptivecards/objectmodel/OpenUrlActionParser", DoNotGenerateAcw=true)]
	public partial class OpenUrlActionParser : global::IO.Adaptivecards.Objectmodel.ActionElementParser {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("io/adaptivecards/objectmodel/OpenUrlActionParser", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (OpenUrlActionParser); }
		}

		protected OpenUrlActionParser (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lio_adaptivecards_objectmodel_OpenUrlActionParser_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.adaptivecards.objectmodel']/class[@name='OpenUrlActionParser']/constructor[@name='OpenUrlActionParser' and count(parameter)=1 and parameter[1][@type='io.adaptivecards.objectmodel.OpenUrlActionParser']]"
		[Register (".ctor", "(Lio/adaptivecards/objectmodel/OpenUrlActionParser;)V", "")]
		public unsafe OpenUrlActionParser (global::IO.Adaptivecards.Objectmodel.OpenUrlActionParser p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (OpenUrlActionParser)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (((object) this).GetType (), "(Lio/adaptivecards/objectmodel/OpenUrlActionParser;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, "(Lio/adaptivecards/objectmodel/OpenUrlActionParser;)V", __args);
					return;
				}

				if (id_ctor_Lio_adaptivecards_objectmodel_OpenUrlActionParser_ == IntPtr.Zero)
					id_ctor_Lio_adaptivecards_objectmodel_OpenUrlActionParser_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Lio/adaptivecards/objectmodel/OpenUrlActionParser;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lio_adaptivecards_objectmodel_OpenUrlActionParser_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (((global::Java.Lang.Object) this).Handle, class_ref, id_ctor_Lio_adaptivecards_objectmodel_OpenUrlActionParser_, __args);
			} finally {
			}
		}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.adaptivecards.objectmodel']/class[@name='OpenUrlActionParser']/constructor[@name='OpenUrlActionParser' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe OpenUrlActionParser ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='io.adaptivecards.objectmodel']/class[@name='OpenUrlActionParser']/constructor[@name='OpenUrlActionParser' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='boolean']]"
		[Register (".ctor", "(JZ)V", "")]
		protected unsafe OpenUrlActionParser (long p0, bool p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::IO.Adaptivecards.Objectmodel.OpenUrlActionParser __this = global::Java.Lang.Object.GetObject<global::IO.Adaptivecards.Objectmodel.OpenUrlActionParser> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='io.adaptivecards.objectmodel']/class[@name='OpenUrlActionParser']/method[@name='DeserializeFromString' and count(parameter)=4 and parameter[1][@type='io.adaptivecards.objectmodel.ElementParserRegistration'] and parameter[2][@type='io.adaptivecards.objectmodel.ActionParserRegistration'] and parameter[3][@type='io.adaptivecards.objectmodel.AdaptiveCardParseWarningVector'] and parameter[4][@type='java.lang.String']]"
		...
		static IntPtr id_getCPtr_Lio_adaptivecards_objectmodel_OpenUrlActionParser_;
		// Metadata.xml XPath method reference: path="/api/package[@name='io.adaptivecards.objectmodel']/class[@name='OpenUrlActionParser']/method[@name='getCPtr' and count(parameter)=1 and parameter[1][@type='io.adaptivecards.objectmodel.OpenUrlActionParser']]"
		[Register ("getCPtr", "(Lio/adaptivecards/objectmodel/OpenUrlActionParser;)J", "")]
		protected static unsafe long GetCPtr (global::IO.Adaptivecards.Objectmodel.OpenUrlActionParser p0)
		{
			if (id_getCPtr_Lio_adaptivecards_objectmodel_OpenUrlActionParser_ == IntPtr.Zero)
				id_getCPtr_Lio_adaptivecards_objectmodel_OpenUrlActionParser_ = JNIEnv.GetStaticMethodID (class_ref, "getCPtr", "(Lio/adaptivecards/objectmodel/OpenUrlActionParser;)J");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				long __ret = JNIEnv.CallStaticLongMethod  (class_ref, id_getCPtr_Lio_adaptivecards_objectmodel_OpenUrlActionParser_, __args);
				return __ret;
			} finally {
			}
		}
